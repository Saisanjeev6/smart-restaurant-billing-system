...
const SuggestTipOutputSchema = z.object({
  ...
  suggestedTipAmount: z
    .number()
    .describe('The suggested tip amount in the local currency (e.g., INR).'),
  reasoning: z
    .string()
...
Consider factors such as customer satisfaction, order complexity, and payment method. The currency for amounts is assumed to be the local currency of the restaurant (e.g., INR if the restaurant is in India).
